<x-layouts.app page-title="Verifica email" card-title="Verifica email">
    <div class="h-full flex flex-col justify-center items-center gap-y-5" x-data="{ loading: false }">
        <x-card class="w-full sm:w-[500px] spacey-5 lg:px-10" shadow>
            ...
            <p class="text-justify text-sm">
                Prima di iniziare, puoi verificare il tuo indirizzo email cliccando sul link che ti abbiamo appena
                inviato per
                email.
                Se non hai ricevuto nessuna email, possiamo inviartene un'altra. Premi il pulsante qui sotto per
                richiederne
                un'altra.
            </p>
