...
<x-main with-nav full-width>
        ...
        @auth()
            <x-menu :title="null" activate-by-route>
                ...
                <x-custom-menu-sub title="Valutazioni" icon="o-list-bullet" route="surveys.*">
                    ...
                    <x-menu-item
                        title="Templates" :link="route('surveys.templates.index')" route="surveys.templates.index"
                    />
                </x-custom-menu-sub>
                <x-custom-menu-sub title="Questionari" icon="o-document-chart-bar" route="questionnaires.*">
                    <x-menu-item
                        title="Questionari" :link="route('questionnaires.index')" route="questionnaires.index"
                    />
    ...
    {{-- The `$slot` goes here --}}
    <x-slot:content>
        <div class="mb-5 md:px-2 lg:px-4 xl:px-8 h-full">
            {{ $slot }}
        </div>
    </x-slot:content>
</x-main>
