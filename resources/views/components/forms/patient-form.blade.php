<x-form wire:submit="save" class="[&_label]:!pb-0 !gap-2">
    ...
    <div class="grid md:grid-cols-2 gap-x-4">
        <x-input
            ...
            required error-field="first_name"
        />
        <x-input
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-4">
        <div class="grid sm:grid-cols-2 gap-x-4">
            <div class="col-span-1">
                <x-input
                    class="input-sm bg-base-200" label="Peso" wire:model.live.debounce="form.weight" first-error-only
                >
                    <x-slot:append>
            ...
            <div class="col-span-1">
                <x-input
                    class="input-sm bg-base-200" label="Altezza" wire:model.live.debounce="form.height" first-error-only
                >
                    <x-slot:append>
