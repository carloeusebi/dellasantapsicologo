...
<div x-data="{ confirmedDelete: false }">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-y-8 xl:gap-x-8 items-start mb-8 xl:mb-4">
        ...
        <div class="space-y-8 xl:space-y-4 col-span-1">
                ...
                <div class="grid md:grid-cols-2 gap-2">
                    <div class="flex flex-col gap-2 items-end md:order-1">
                        ...
                        @else
                            ...
                            />
                            <x-button
                                class="w-full" link="{{ route('surveys.create', ['patient_id' => $patient->id]) }}"
                            >
                                Nuova Valutazione
                            </x-button>
                        @endif
            ...
            <livewire:patients.components.surveys-table :$patient/>
        </div>
    </div>

    <div>
        <livewire:patients.components.patient-files :patient="$patient"/>
    </div>
