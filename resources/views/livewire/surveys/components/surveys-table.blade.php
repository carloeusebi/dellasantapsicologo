...
<x-custom.table :rows="$surveys">
    <x-slot:filters>
        <x-select
            ...
            :options="[
            ['id' => self::ALL, 'name' => 'Tutti'],
            ['id' => self::COMPLETED, 'name' => 'Completati'],
            ['id' => self::NOT_COMPLETED, 'name' => 'Non Completati'],
         ]"
        />
        <x-select
            ...
            :options="[
            ['id' => self::ALL, 'name' => 'Tutti'],
            ['id' => self::CURRENT, 'name' => 'Attuali'],
            ['id' => self::ARCHIVED, 'name' => 'Archiviati']
        ]"
        />
