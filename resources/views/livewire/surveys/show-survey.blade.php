    ...
    <div>
        <div class="tabs tabs-bordered mb-5 overflow-x-auto">
            ...
            @if($survey->skipped_questions_count > 0)
                <div
                    class="tab space-x-2" :class="{ 'tab-active': $wire.tab === 'saltate' }"
                    wire:click="tab = 'saltate'"
                >
        ...
        <div>
            <div x-show="$wire.tab === 'dettagli'">
                <livewire:surveys.tabs.details-tab :$survey lazy/>
            </div>
            ...
            <div x-show="$wire.tab === 'commenti'">
                <livewire:surveys.tabs.comments-tab :$survey lazy/>
            </div>
