    ...
    <x-form wire:submit="save" class="[&_.label]:!pb-0 !gap-2">
        ...
        <div class="grid lg:grid-cols-6 gap-x-4">
            <div class="lg:col-span-2">
                <x-datepicker
                    class="input-sm bg-white"
                    label="Data di nascita" wire:model.live.debounce="form.birth_date"
                    :config="['altFormat' => 'd F Y']"
                    icon="o-cake"
                />
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-4">
            <div class="grid sm:grid-cols-2 gap-x-4">
                <div class="col-span-1">
                    <x-input class="input-sm bg-white" label="Peso" wire:model.live.debounce="form.weight"
                             first-error-only>
                        <x-slot:append>
                ...
                <div class="col-span-1">
                    <x-input class="input-sm bg-white" label="Altezza" wire:model.live.debounce="form.height"
                             first-error-only>
                        <x-slot:append>
